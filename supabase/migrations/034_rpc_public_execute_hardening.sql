...
-- Revoke that implicit grant as well as role-specific grants so SECURITY DEFINER
-- helpers cannot be reached through the exposed REST RPC surface anonymously.
do $$
declare
  r record;
begin
