...
export interface ServiceRequest{id:string;customer_id:string;category_id:string|null;service_id:string|null;delivery_mode:ServiceDeliveryMode;description:string;suburb:string|null;city:string|null;state:string|null;preferred_date:string|null;preferred_time:string|null;budget:number|null;status:RequestStatus;created_at:string;}
