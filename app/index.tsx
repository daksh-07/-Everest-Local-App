...
const styles=(c:ThemeColors,desktop:boolean)=>StyleSheet.create({
 ...
 heroGrid:{flexDirection:desktop?'row':'column',gap:desktop?16:0,alignItems:'stretch',marginTop:desktop?20:8},heroPanel:{flex:desktop?1.15:undefined,minWidth:0,borderRadius:desktop?28:0,backgroundColor:desktop?c.elevated:'transparent',borderWidth:desktop?1:0,borderColor:c.border,padding:desktop?24:0},sidePanel:{flex:desktop?.85:undefined,minWidth:0,paddingTop:desktop?20:0},heroEyebrow:{fontSize:8,fontWeight:'900',letterSpacing:1.3,color:c.accent,marginTop:desktop?0:14},greeting:{fontSize:desktop?38:29,lineHeight:desktop?44:35,fontWeight:'900',letterSpacing:-1,color:c.text,marginTop:8},heroCopy:{fontSize:desktop?14:13,lineHeight:21,color:c.textSecondary,marginTop:7,maxWidth:620},search:{height:58,borderRadius:18,backgroundColor:c.surface,flexDirection:'row',alignItems:'center',gap:10,paddingHorizontal:10,marginTop:20,borderWidth:1,borderColor:c.border,shadowColor:'#000',shadowOpacity:.06,shadowRadius:14,shadowOffset:{width:0,height:7}},searchPressed:{transform:[{scale:.985}],opacity:.86},searchIcon:{width:38,height:38,borderRadius:12,backgroundColor:c.soft,alignItems:'center',justifyContent:'center'},searchText:{flex:1,fontSize:13,color:c.textSecondary},primaryIntent:{minHeight:84,borderRadius:20,backgroundColor:c.brand,flexDirection:'row',alignItems:'center',gap:12,padding:15,marginTop:12},primaryIntentIcon:{width:43,height:43,borderRadius:14,backgroundColor:'rgba(255,255,255,.13)',alignItems:'center',justifyContent:'center'},primaryIntentTitle:{fontSize:14,fontWeight:'900',color:c.onBrand},primaryIntentCopy:{fontSize:10,lineHeight:15,color:c.onBrand,opacity:.82,marginTop:3},trustRow:{flexDirection:'row',flexWrap:'wrap',gap:14,marginTop:13},
 ...
 shortcutLabel:{fontSize:8,fontWeight:'900',letterSpacing:1.1,color:c.muted,marginTop:18,marginBottom:6},actionGrid:{gap:6},action:{minHeight:58,borderRadius:15,backgroundColor:c.surface,borderWidth:1,borderColor:c.border,paddingHorizontal:11,flexDirection:'row',alignItems:'center',gap:10},actionPressed:{transform:[{scale:.985}],backgroundColor:c.soft},actionIcon:{width:36,height:36,borderRadius:12,backgroundColor:c.accentSoft,alignItems:'center',justifyContent:'center'},actionTitle:{fontSize:11,fontWeight:'900',color:c.text},actionCopy:{fontSize:8,color:c.muted,marginTop:2},
