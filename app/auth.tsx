  ...
  return (
    <View style={s.safe}>
      <View style={s.content}>
        ...
        <Pressable onPress={retry} style={s.button}>
  ...
  return (
    <View style={s.safe}>
      <View style={s.content}>
        ...
        {mode === 'login' && (
          <Pressable onPress={() => { setMode('reset'); setError(''); setNotice(''); }}>
        ...
        <Pressable disabled={busy} onPress={() => void submit()} style={s.button}>
          {busy ? (
...
const s = StyleSheet.create({
  ...
  copy: { fontSize: 14, lineHeight: 21, color: '#777', marginTop: 10, marginBottom: 25 },
  ...
  buttonText: { color: '#fff', fontWeight: '900', fontSize: 12, letterSpacing: 0.7 },
