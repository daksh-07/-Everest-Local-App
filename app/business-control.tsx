...
export default function BusinessControl(){
 ...
 const sections=[
  ...
  {label:'OPERATIONS',rows:[['CRM workspace','layers-outline','/business-crm'],['Growth','trending-up-outline','/business-growth'],['Offers & retention','gift-outline','/business-growth-p1'],['Contacts','people-outline','/business-customers'],['Calendar','calendar-outline','/business-calendar'],['Automations','flash-outline','/business-automations'],['Integrations','extension-puzzle-outline','/business-integrations'],['Everest marketplace leads','pulse-outline','/business-leads'],['Customer orders','bag-handle-outline','/business-orders'],['Availability','radio-outline','/business-availability']]},
