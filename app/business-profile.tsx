...
export default function BusinessProfile() {
  ...
  return <SafeAreaView style={s.safe}><ScrollView contentContainerStyle={s.page}>
    ...
    <View style={s.actions}><Pressable style={s.actionPrimary} onPress={()=>router.push('/request')}><Text style={s.actionPrimaryText}>REQUEST QUOTE</Text></Pressable><Pressable style={s.actionSecondary} onPress={()=>router.push('/messages')}><Text style={s.actionSecondaryText}>MESSAGE</Text></Pressable></View>
