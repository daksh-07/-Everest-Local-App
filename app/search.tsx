...
export default function Search() {
  ...
  return <SafeAreaView style={s.safe}>
    <ScrollView contentContainerStyle={s.page} keyboardShouldPersistTaps="handled" keyboardDismissMode="on-drag">
      ...
      <View style={s.search}><Ionicons name="search" size={20} color="#777"/><TextInput accessibilityLabel="Search Everest Local" value={q} onChangeText={setQ} placeholder="Search businesses, services, products or jobs" placeholderTextColor="#888" selectionColor="#111" style={[s.input, webSearchInputStyle]} returnKeyType="search"/></View>
