...
const styles=(c:ThemeColors)=>StyleSheet.create({
 ...
 composerCard:{marginTop:10,borderWidth:1,borderColor:c.border,borderRadius:20,backgroundColor:c.surface,overflow:'hidden',shadowColor:'#000',shadowOpacity:.1,shadowRadius:14,shadowOffset:{width:0,height:7}},caption:{minHeight:118,fontSize:17,lineHeight:25,color:c.text,textAlignVertical:'top',paddingHorizontal:16,paddingTop:16,paddingBottom:6,borderWidth:0},composerFooter:{height:28,paddingHorizontal:14,alignItems:'flex-end',justifyContent:'center'},counter:{fontSize:9,color:c.muted},
