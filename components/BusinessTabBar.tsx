...
type Route='/business-today'|'/business-leads'|'/business-customers'|'/business-jobs'|'/business-inbox'|'/business-control';
type ActiveRoute=Route|'/business-availability'|'/business-orders';
...
export function BusinessTabBar({active}:{active:ActiveRoute}){
...
const s=StyleSheet.create({shell:{position:'absolute',left:0,right:0,bottom:0,zIndex:50,borderTopWidth:1},bar:{height:64,width:'100%',maxWidth:760,alignSelf:'center',flexDirection:'row',justifyContent:'space-around',alignItems:'center'},item:{minWidth:52,minHeight:56,alignItems:'center',justifyContent:'center',paddingHorizontal:4},pressed:{opacity:.58},label:{fontSize:10,lineHeight:14,fontWeight:'700',marginTop:3},active:{fontWeight:'900'}});
