...
7. Register for the free ABN Lookup web services and store the issued `ABR_AUTH_GUID` only as a Supabase Edge Function secret; never expose it to the Expo client.
...
11. Complete the final launch gate in `docs/FINAL_LAUNCH_GATE.md` before public release.
